    ...
    return (
        <> 
            ...
            <div className={`p-3 position-relative transition-all duration-700  ${props.isEventVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-32"} `} id="events" ref={props.eventsRef}>
                ...
                // style={{backgroundImage:"linear-gradient(to left, #9cecfb, #65c7f7, #0052d4)"}}
                >
                    <div className="heading md:w-4/12 sm:w-6/12 w-full text-2xl font-[800] uppercase sm:my-4 text-center">
                    ...
                    <div className=" md:w-5/12 sm:w-9/12 w-full mx-6 my-4 overflow-hidden">
                        <div className='slide flex justify-between items-start' style={{width:"400%"}}>
