        ...
        <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white px-6 md:px-12">
                    ...
                    <div className='text-xl text-gray-800 pt-1 '>
                     ...
                     <br/>
                     <div className='pt-3'> 
                        <span className='text-black text-3xl pt-4 tracking-wide underline font-bold'>
                            {text}
                      ...
                      <a href="https://drive.google.com/file/d/19Js8ByMzdl9scU3ACAEHHcEIpRsi2BTE/view?usp=drive_link" target='blank'>
