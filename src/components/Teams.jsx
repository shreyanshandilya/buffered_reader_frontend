      ...
      <section className="text-gray-600 body-font">
        ...
        <div className="container px-5 py-24 mx-auto">
            ...
            <div className="p-8 md:w-1/3">
                ...
                <img className="lg:h-60 md:h-36 w-full object-cover object-center" src="/eth.jpeg" alt="blog"/>
                <div className="p-6">
                    <h2 className="tracking-widest text-xs text-center title-font font-medium text-gray-400 mb-3">CATEGORY</h2>
                    <h1 className="title-font text-2xl font-medium text-gray-900 mb-1">The Catalyzer</h1>
                    <h2 className="tracking-widest text-lg title-font font-medium text-gray-400 mb-1">Work Done</h2>
                    <div className="flex items-center flex-wrap ">
                    <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Linked In
