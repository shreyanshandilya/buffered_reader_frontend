          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="flex flex-wrap -m-4 justify-center">
              ...
              <div className="flex flex-wrap -m-4 justify-center">
                ...
                {/* <div className="font-bold flex flex-wrap -m-4 justify-center">EXECUTIVE COMMITTEE</div> */}

                <div className="p-4 lg:w-1/3 md:w-1/2">
                  <div className="h-full flex flex-col items-center text-center">
                    <img
                      alt="team"
                      className=" border-2 border-slate-900 flex-shrink-0 rounded-lg w-full h-50 object-center mb-4"
                      src="/ck_sir.jpg"
                    />
